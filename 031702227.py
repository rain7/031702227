...
if num==3:
    ...
    #print(location)
    #地址反编码
    url = 'https://restapi.amap.com/v3/geocode/regeo?output=xml&location='+location+'&key=46b59533e5942f662c8201f2df21a7d9&radius=50&extensions=all'
    res = requests.get(url).text
    #print(res)
